...
""",
    ...
    'assets': {
        # Backend: widget AEI completo + tours + launcher
        'web.assets_backend': [
        ...
        # /payment/qr_mercantil/display…): widget AEI vanilla-JS + tours +
        # launcher, para que un visitante anónimo también pueda preguntar
        # "¿cómo hago una compra?" y reanudar tours pendientes tras un redirect.
        'web.assets_frontend': [
            'aei_user_tours/static/src/scss/aei_assistant.scss',
